...
- **[Provider safety guardrails blocked incident response during the Hugging Face agentic intrusion](harness-agent-security/2026-07-provider-safety-guardrails-blocked-incident-response-during.md)** · composite **54.75** · Jul 19, 2026 · ⚠️ _review_  
...
- **[Self-state attacks: corrupting an agent's own memory and config uses legitimate syscalls](harness-agent-security/2026-07-self-state-attacks-corrupting-an-agent-s-own-memory-and-conf.md)** · composite **49.12** · Jul 20, 2026 · ⚠️ _review_  
...
- **[ToolHive MCP SSRF: host-side discovery runs outside the sandbox it enforces](mcp-tools/2026-07-toolhive-mcp-ssrf-host-side-discovery-runs-outside-the-sandb.md)** · composite **62.4** · Jul 15, 2026  
...
- **[ShadowPickle: pickle-VM import tricks evade ten model scanners and four model hubs](model-supply-chain/2026-07-shadowpickle-pickle-vm-import-tricks-evade-ten-model-scanner.md)** · composite **57.22** · Jul 20, 2026  
...
- **[Agent skill security is a lifecycle problem, not just a runtime one (SkillSec-Eval)](skill-supply-chain/2026-07-agent-skill-security-is-a-lifecycle-problem-not-just-a-runti.md)** · composite **56.85** · Jul 16, 2026  
