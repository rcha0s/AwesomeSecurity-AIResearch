...
- **[AI Security](ai-security/README.md)** (36 vetted findings). Securing AI systems: harness & agent security, MCP, skill scanning, prompt injection, memory poisoning, model supply chain, LLM red-teaming.
...
- **[AI Research](ai-research/README.md)** (10 vetted findings). Practitioner AI: improving your harness, understanding, and architecture for using LLMs/agents on real tasks. Not model internals or ML-research.
...
<sub>Generated by <code>scripts/generate_site.py</code> on 2026-08-31. Edit the pools in <code>data/</code> and regenerate - do not hand-edit rendered files.</sub>
